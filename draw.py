...
class Button:  # button
    def __init__(self, screen, msg):
        ...
        self.font = pygame.font.Font('msyh.ttf', 48)
...
def draw_text(screen, center, text, text_size, font_type, bg_color):  # text
    text_color = (255, 0, 0)
    bg_color.a = 0
    font = pygame.font.Font('STZHONGS.TTF', text_size)
...
def draw_player(screen, player, role, stop_picture):
...
def draw_mapstatus(screen, player, map_status):
